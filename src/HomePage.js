            ...
            <div className='CompanyContent'>
                <div className='AboutUs'>
                    <div className='AboutUsContent' ref={aboutUsContentRef}>
                        ...
                        <p style={{ paddingLeft: "20px" }}>創客兔科技深耕產業數位轉型，我們深知傳統產業的珍貴價值與豐富經驗。</p>
                        <p style={{ paddingLeft: "20px" }}>透過創新科技的導入，我們協助企業保留既有優勢，同時開創嶄新商機。讓每一次的轉型，都能帶來實質的營運提升。</p>
                    </div>
                ...
                <div className='TeamConcept'>
                    <div className='TeamConceptContent' ref={teamConceptContentRef}>
                        ...
                        <div className='TeamConceptText'>
                            <p>MakerRabbit 深信，每個人都有獨特的需求與挑戰。</p>
                            <p>我們的使命是深入了解大眾的需求，提供多元且客製化的服務。</p>
                            <p>不論您是渴望學習的新手學生、技術精湛的工程師，或是尋求解決方案的發案者，我們都以解決您的需求為首要目標。</p>
